...
import com.csdig.db.core.BeanProcessor;
...
public class ArrayHandler implements ResultSetHandler<Object[]> {
    ...
    protected ColumnFilter filter = null;
    /**
    ...
    public ArrayHandler(ColumnFilter filter) {
        this(new BasicRowProcessor(new BeanProcessor(filter)));
    }
