...
/**
 * <code>ResultSetHandler</code> implementation that converts the first <code>ResultSet</code> row into a JavaBean. This class
 * is thread safe.
 * 
...
public class BeanHandler<T> implements ResultSetHandler<T> {
    ...
    public BeanHandler(Class<T> type, ColumnFilter filter) {
        this(type, new BasicRowProcessor(filter));
    }
