...
<form id="addlogform" method="post" action="${admin_base}/log/save.at" novalidate>
	
	<table align="center" width="100%" >
		<tr>   
			<td>所属栏目:</td>
			<td>
				<select class="easyui-combobox" name="channelId">
		...
		<tr>
			<td>标题:</td>
			<td>
				<input class="easyui-validatebox textbox" type="text" maxlength=30 name="title" data-options="required:true"></input>
			</td>
		</tr>
		...
		<tr>
			<td>更新日期:</td>
			<td>
				<input class="easyui-datebox" type="text" name="disDate" data-options="required:true"></input>
			</td>
		</tr>
...
<script type="text/javascript">
	 function add(){
		 ...
		 "条目描述：<input type='text' maxlength=30 name='desc' style='width: 220px' class='easyui-validatebox textbox' required='true' value="+itemDesc+"></input>"+
